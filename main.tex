...
\usepackage[left=3 cm,right=3cm,top=2cm,bottom=3cm,includeheadfoot]{geometry} 
\usepackage{xcolor}
\usepackage{setspace}
\usepackage{nameref}
...
% Commands for stuff that gets used a lot
\def\name{LEAGUE NAME}
...
\hypersetup{
    ...
    filecolor=magenta,      
    urlcolor=blue,
    pdftitle={CS2 Rulebook Online League}, %title of the pdf when opened in a browser
    pdfpagemode=FullScreen,
    }

\title{\name\\ Swiss Counter Strike 2 Community League\\Rulebook Season 1}
\author{Noah 'Alastor' Baldinger, Jan 'Icy' Urech}
\date{\today \hspace{1cm} Version Beta 1.3} %date of last change: 29.1.24
% counterread by Raiden and ShebX
